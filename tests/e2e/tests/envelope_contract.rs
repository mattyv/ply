...
//! and part was real: the envelope, which is the agent-facing channel,
//! carried verdicts and nothing else. A consumer could read `fuzzed(64)`
//! with no way to know what it was fuzzed *for*.
//!
